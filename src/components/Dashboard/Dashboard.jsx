  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="flex flex-col text-center w-full mb-20">
        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Dashboard</h1>
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Natus accusamus eum dolorem, minus blanditiis neque facilis. Maxime officiis facere a architecto fuga maiores omnis, nam enim doloribus? Possimus, vel aliquid.</p>
      </div>
      <div className="flex flex-wrap -m-4 text-center">
        ...
        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
          <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
            ...
            <p className="leading-relaxed">Campaigns Rasied</p>
          </div>
        </div>
        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
          <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
            ...
            <p className="leading-relaxed">NFTs Minted</p>
